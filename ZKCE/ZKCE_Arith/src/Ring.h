...
public:
	...
	void addGaussAndEqualAndSave(ZZ* res, ZZ* mi, const ZZ& q);

	void sampleGauss(ZZ* mi);
	...
	void decomposeNoise(ZZ* m, ZZ* m1, ZZ* m2, ZZ* m3, const ZZ& q);

	void decomposeNoise(ZZ* m, ZZ* m1, ZZ* m2, ZZ* m3, const ZZ& q, const unsigned char data1, const unsigned char data2);

	void decomposeNoise(ZZ* m, ZZ* m1, ZZ* m2, ZZ* m3, const ZZ& q, int k1, int k2, int offset);

	void compare(ZZ* m1, ZZ* m2);

	void compareNoisy(ZZ* m1, ZZ* m2);
