...
public:
	...
	void encrypt(Ciphertext& cipher, Plaintext plain, complex<double>* mvec, long n, long logp, long logq, long np, ZZ* vx, ZZ* m0, ZZ* m1);
	...
	void multByConstVec(Ciphertext& res, Ciphertext& cipher, Plaintext& cnstVec, long logp);

	void multByConstVecSlot(Ciphertext& res, Ciphertext& cipher, long logp);
